                    ...
                    <div class="flex flex-col space-y-4">
                        ...
                        <div class="flex justify-between items-start">
                            ...
                            <div class="text-right">
                                ...
                                <p class="text-sm text-gray-500 mt-1">Base Price: $${item.price.toLocaleString()}</p>
                            </div>
                        </div>

                        <!-- Expandable Details Button -->
                        <button class="toggle-details flex items-center text-blue-600 hover:text-blue-800 transition-colors duration-150">
                            <span class="toggle-icon mr-2 font-bold">+</span>
                            View Details
                        </button>

                        <!-- Expandable Details Section -->
                        <div class="hidden pl-4 space-y-4 border-l-2 border-gray-200">
                            <!-- Upgrades Section -->
                                    ...
                                    <div class="grid gap-2">
                                        ${item.insurancePlans.map(plan => `
                                            <div class="flex justify-between items-center bg-gray-50 p-2 rounded">
                                                ...
                                                <span class="font-medium">$${plan.annualPremium.toLocaleString()}/year</span>
                                            </div>
                                        `).join('')}
                                    </div>
                                </div>
