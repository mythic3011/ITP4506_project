export class OrderDetailsView {
    ...
    renderOrderInfo(order) {
        ...
        this.elements.orderDate.textContent = order.date;
    ...
    renderTradeInInfo(tradeInValue) {
        if (tradeInValue === 0) {
            this.elements.tradeinDetails.innerHTML = `
                <div class="info-item">
                    <span class="label">Trade-In Value</span>
                    <span class="value">$0</span>
                </div>
            `;
            console.log('tradein value is 0');
            return;
        }

        this.elements.tradeinDetails.innerHTML = `
            <div class="info-item" id="tradein-value">
                <span class="label">Trade-In Value</span>
                <span class="value">${formatCurrency(tradeInValue)}</span>
            </div>
        `;
    }
}
